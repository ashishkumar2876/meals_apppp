...
import 'package:meals_apppp/data/dummy_data.dart';
import 'package:meals_apppp/models/category.dart';
import 'package:meals_apppp/screens/meals.dart';
import 'package:meals_apppp/widgets/category_grid_item.dart';
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(animation: _animationController,
        ...
        SlideTransition(position:
          Tween(begin: const Offset(0, 0.3),
